...
| 4-6. Backend, accounts, isolation | In progress | PostgreSQL integration, cross-user denial and hashed single-use password-reset backend pass; native reset surfaces and deployment remain |
