...
| 7-10. Sync, clients, shared core | In progress | Server push/pull, shared offline queue, protected Windows credentials, native transport and token-free account bridge are tested; visible account UI, sync wiring and Android transport remain |
